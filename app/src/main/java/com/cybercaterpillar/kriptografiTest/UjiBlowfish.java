...
public class UjiBlowfish extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       //db.deleteAllS1hasilenkripsi();
        ...
        /*for (Skenario1 sn1 : skenario1) {
            final long startTime = System.nanoTime();
            //--enkirpsi--
            String hasilEnkripsi = enkripsi(sn1.getID(), sn1.getTeks(), sn1.getKunci());
            //--enkirpsi--
            String log = "Id: " + sn1.getID() + " ,Bytes: " + sn1.getBytes() + " ,Teks: " + sn1.getTeks() + " ,Kunci: " + sn1.getKunci() + " ,Teks terenkripsi: " + hasilEnkripsi;
            // Writing Contacts to log
            Log.d("Data: ", log);
            listDataS1.add(sn1.getTeks()); //this adds an element to the list.
        }*/
        //----mendapatkan array (teks) yang tersimpan dalam arraylist
        /*Object[] mStringArray = listDataS1.toArray();
                ...
                new Thread(new Runnable() {
                    public void run() {
                        for (Skenario1 sn1 : _skenario1) {
                            ...
                            String log = "Id: " + sn1.getID() + " ,Bytes: " + sn1.getBytes() + " ,Teks: " + sn1.getTeks() + " ,Kunci: " + sn1.getKunci() + " ,Teks terenkripsi(Blowfish): " + hasilEnkripsi;
                            // Writing data to log
                            Log.d("Data: ", log);
