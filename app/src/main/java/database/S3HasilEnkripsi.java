...
public class S3HasilEnkripsi {
    ...
    // Empty constructor
    public S3HasilEnkripsi(){

    }
    // constructor
    public S3HasilEnkripsi(int id, int idskenario3, String teksenkripsi, String kunci){
        this._id = id;
    ...
    // constructor
    public S3HasilEnkripsi(int idskenario3, String teksenkripsi, String kunci){
        this._idskenario3 = idskenario3;
        this._teksenkripsi = teksenkripsi;
        this._kunci = kunci;
    }
