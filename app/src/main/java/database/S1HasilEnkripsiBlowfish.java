...
public class S1HasilEnkripsiBlowfish {
    //private variables
    int _id;
    int _idskenario1;
    ...
    // Empty constructor
    public S1HasilEnkripsiBlowfish(){

    }
    // constructor
    public S1HasilEnkripsiBlowfish(int id, int idskenario1, String teksenkripsi, String kunci){
        this._id = id;
    ...
    // constructor
    public S1HasilEnkripsiBlowfish(int idskenario1, String teksenkripsi, String kunci){
        this._idskenario1 = idskenario1;
        this._teksenkripsi = teksenkripsi;
        this._kunci = kunci;
    }
